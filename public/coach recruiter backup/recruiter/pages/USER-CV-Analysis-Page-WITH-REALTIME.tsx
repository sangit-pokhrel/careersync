...
export default function CVAnalysis() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">CV Analysis</h1>
        <p className="text-gray-600">
          Upload your CV for AI-powered analysis and get personalized job recommendations
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl p-8 shadow-xl">
            <div className="flex items-center gap-6">
              ...
              <div className="text-center">
                <div className="text-5xl font-bold mb-1">{completedAnalysis.overallScore}</div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold">{completedAnalysis.skillsDetected.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold">{completedAnalysis.strengths.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold">{completedAnalysis.recommendations.length}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="flex flex-wrap gap-2">
              {completedAnalysis.skillsDetected.slice(0, 15).map((skill, index) => (
                <span
                  key={index}
