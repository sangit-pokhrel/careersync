            ...
            <div key={assignment._id} className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <div className="grid grid-cols-4 gap-4 mb-4">
                <div className="bg-gray-50 p-3 rounded-xl">
                  ...
                  <div className="text-2xl font-bold">{assignment.totalAssigned}</div>
                </div>
                <div className="bg-blue-50 p-3 rounded-xl">
                  <div className="text-sm text-blue-500">Submitted</div>
                  <div className="text-2xl font-bold text-blue-600">{assignment.totalSubmitted}</div>
                </div>
                <div className="bg-green-50 p-3 rounded-xl">
                  <div className="text-sm text-green-500">Reviewed</div>
                  <div className="text-2xl font-bold text-green-600">{assignment.totalReviewed}</div>
                </div>
                <div className="bg-orange-50 p-3 rounded-xl">
                  <div className="text-sm text-orange-500">Pending</div>
                  <div className="text-2xl font-bold text-orange-600">
                    {assignment.totalSubmitted - assignment.totalReviewed}
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="border border-gray-300 rounded-xl p-4 max-h-48 overflow-y-auto">
                  {eligibleStudents.length === 0 ? (
                    <p className="text-gray-500">No eligible students (must have completed interview or be premium)</p>
                  ) : (
