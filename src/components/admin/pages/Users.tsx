...
export default function Users() {
  ...
  }, [allUsers, searchQuery, statusFilter, roleFilter, currentPage]);
  ...
  const calculateStats = () => {
    ...
    const pending = allUsers.filter(u => u.status === 'pending_verification').length;
    const verified = allUsers.filter(u => u.status === 'verified').length;
    ...
    const csrs = allUsers.filter(u => u.role === 'csr').length;
    const sales = allUsers.filter(u => u.role === 'sales').length;
    const students = allUsers.filter(u => u.role === 'student').length;

    setStats({ total, active, pending, verified, admins, jobSeekers, employers, users, csrs, sales, students });
  };
  ...
  const fetchAllUsers = async () => {
    try {
      ...
      while (hasMorePages) {
        ...
        allFetchedUsers = [...allFetchedUsers, ...pageUsers];

        console.log(`📄 Page ${currentPageNum}: ${pageUsers.length} users (Total so far: ${allFetchedUsers.length})`);
      ...
      console.log(`✅ Fetched ${allFetchedUsers.length} total users`);
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-teal-600 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-gray-600 font-medium">Loading all users from database...</p>
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">
            Showing {displayUsers.length} of {filteredUsers.length} filtered users 
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-xl p-4 shadow-sm border-2 border-purple-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-xs font-medium">Admins</p>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-2 border-blue-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-xs font-medium">Job Seekers</p>
              <p className="text-xl font-bold text-blue-600 mt-1">{stats.jobSeekers}</p>
            </div>
            <span className="text-2xl">🔍</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-2 border-green-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-xs font-medium">Employers</p>
              <p className="text-xl font-bold text-green-600 mt-1">{stats.employers}</p>
            </div>
            <span className="text-2xl">🏢</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-2 border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-xs font-medium">Users</p>
              <p className="text-xl font-bold text-gray-600 mt-1">{stats.users}</p>
            </div>
            <span className="text-2xl">👤</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-2 border-indigo-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-xs font-medium">Students</p>
              <p className="text-xl font-bold text-indigo-600 mt-1">{stats.students}</p>
            </div>
            <span className="text-2xl">🎓</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-2 border-orange-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-xs font-medium">CSRs</p>
              <p className="text-xl font-bold text-orange-600 mt-1">{stats.csrs}</p>
            </div>
            <span className="text-2xl">📞</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-2 border-pink-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-xs font-medium">Sales</p>
              <p className="text-xl font-bold text-pink-600 mt-1">{stats.sales}</p>
            </div>
            <span className="text-2xl">💼</span>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold">
            Users ({displayUsers.length} showing / {filteredUsers.length} filtered / {stats.total} total)
          </h2>
        </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-5 rounded-xl border-l-4 border-gray-500">
                    ...
                    <div className="space-y-3">
                      <div>
                        <p className="text-xs text-gray-700 font-semibold uppercase">Created</p>
                        <p className="font-medium bg-white p-2 rounded mt-1 text-sm">{new Date(selectedUser.createdAt).toLocaleString()}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-700 font-semibold uppercase">Updated</p>
                        <p className="font-medium bg-white p-2 rounded mt-1 text-sm">{new Date(selectedUser.updatedAt).toLocaleString()}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-700 font-semibold uppercase">Last Login</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="flex justify-between items-center p-6 border-b bg-white">
              <div>
                <h2 className="text-3xl font-bold">Edit User Profile</h2>
                <p className="text-gray-500 text-sm mt-1">Modify user information</p>
              </div>
              <button 
                onClick={() => setShowEditModal(false)} 
                className="text-gray-400 hover:text-gray-600 text-3xl leading-none"
              ...
              <div className="overflow-y-auto flex-1 p-6">
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 p-5 rounded-xl border-l-4 border-yellow-500">
                      <h3 className="font-bold text-lg mb-4 text-yellow-900 flex items-center gap-2">
                        <span>ℹ️</span> Read-Only
                      </h3>
                      <div className="space-y-2 text-sm text-yellow-800 bg-white p-3 rounded">
                        <p>⭐ Rating: {selectedUser.averageRating.toFixed(1)}</p>
                        <p>📊 Total Ratings: {selectedUser.totalRatings}</p>
                        <p>🔢 Token Version: {selectedUser.tokenVersion}</p>
                        <p>❌ Failed Attempts: {selectedUser.failedLoginAttempts}</p>
                      </div>
