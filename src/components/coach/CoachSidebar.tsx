...
export default function CoachSidebar() {
  ...
  const menuItems = [
    { icon: '📊', label: 'Dashboard', href: '/coach' },
    { icon: '👥', label: 'Students', href: '/coach/students' },
    { icon: '✏️', label: 'Create Assessment', href: '/coach/interviews/create' },
    { icon: '📝', label: 'Submissions', href: '/coach/submissions' },
    { icon: '📹', label: 'Video Interviews', href: '/coach/video-interviews' },
    { icon: '📚', label: 'Assignments', href: '/coach/assignments' },
    { icon: '⚙️', label: 'Settings', href: '/coach/settings' },
  ];
      ...
      >
        ...
        <div className="p-6 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            {!isSidebarCollapsed && (
              <div>
                <h2 className="font-bold text-xl">Career Coach</h2>
              </div>
            )}
          </div>
        </div>
              ...
              <li key={index}>
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-lg transition-all flex items-center gap-3 ${
                    pathname === item.href || (item.href !== '/coach' && pathname?.startsWith(item.href))
