    ...
    <form className="flex md:justify-end " onSubmit={handleSubmit(onSubmit)}>
      ...
      >
              ...
              {!file ? (
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex justify-center gap-3">
                      <span className="px-3 py-1 text-xs bg-red-50 text-red-600 rounded">
                        <BsFiletypePdf className="inline mr-1" /> PDF
                      </span>
                      <span className="px-3 py-1 text-xs bg-blue-50 text-blue-600 rounded">
                        <BsFileWord className="inline mr-1" /> DOC
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  {(isAnalyzing || progress > 0) && (
                    <div>
                      ...
                      <div className="h-2 bg-gray-100 rounded">
                        <div
                          className="h-full bg-linear-to-r from-cyan-500 to-blue-600 rounded transition-all"
                          style={{ width: `${progress}%` }}
                        />
                      </div>
                    </div>
                  ...
                  {progress === 100 && (
                    <button
                      disabled={AnalyseResumeMutation.isPending}
                      type="submit"
                      className="w-full mt-2 bg-cyan-600 text-white py-2 rounded-lg cursor-pointer hover:bg-cyan-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {AnalyseResumeMutation.isPending ? "Just a Moment..." : "View Analysis"}
                    </button>
                  )}
        ...
        <motion.div
          animate={{ y: [-5, 5, -5] }}
          transition={{ repeat: Infinity, duration: 3 }}
          className="absolute -top-3 -right-3 bg-orange-500 p-2 rounded-xl shadow-lg"
        >
          <BsStars className="text-white" />
        </motion.div>
      </motion.div>
